const Table = () => {
  return (
    <div className="bg-gray-800 p-3 md:p-6 shadow-lg rounded-lg">
      <div className="text-2xl font-semibold mb-4 text-fuchsia-400">
        Grade Point System
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-1 gap-8">
          ...
          <table className="min-w-full table-auto border-collapse text-sm text-gray-300">
            <thead>
              <tr className="bg-slate-900">
                <th className="px-6 py-3 text-left font-semibold text-fuchsia-400">
                  Grade
                </th>
                <th className="px-6 py-3 text-left font-semibold text-fuchsia-400">
                  Grade Point
            ...
            <tbody className="bg-gray-700">
              <tr className="border-t hover:bg-fuchsia-800">
        ...
        <div className="text-sm text-gray-300 space-y-4">
          <div className="text-lg font-semibold text-fuchsia-400">Classes</div>
          ...
          <div className="mt-6 text-sm text-gray-400">
            <p>
              ...
              <a
                ...
                target="_blank"
                className="font-semibold text-fuchsia-400 hover:text-fuchsia-500 hover:underline"
              >
